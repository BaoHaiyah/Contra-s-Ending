...
#define TEXTURE_PATH_MARIO L"bill_animation.png"
...
void LoadResources()
{
	...
	texBill = game->LoadTexture(TEXTURE_PATH_MARIO);
	...
	bill2 = new CBill(BILL_START_X, BILL_START_Y, BILL_START_VX, BILL_START_VY, texBill);
